...
CREATE TABLE "loan_cases" (
	...
	"high_intent_flag" text,
	"follow_up_at" timestamp with time zone,
	"call_summary_latest" text,
	"call_notes_latest" text,
	"inference_extracted_data" jsonb DEFAULT '{}' NOT NULL,
	"inference_context_details" jsonb DEFAULT '{}' NOT NULL,
...
CREATE INDEX "loan_cases_tenant_high_intent_idx" ON "loan_cases" ("tenant_id","high_intent_flag","follow_up_at");
CREATE UNIQUE INDEX "loan_cases_tenant_id_partner_case_id_key" ON "loan_cases" ("tenant_id","partner_case_id");
CREATE INDEX "loan_cases_tenant_inferred_intent_idx" ON "loan_cases" ("tenant_id","inferred_intent","last_call_at");
