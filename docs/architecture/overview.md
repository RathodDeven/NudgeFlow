...
12. Bolna webhook data updates interaction history and latest call inference snapshot on `loan_cases` (intent/disposition/follow-up/summary/extractions) for filtering and CSV export.
